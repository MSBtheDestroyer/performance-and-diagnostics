...
function get_database_details() {
    ...
    $large_tables_data = empty($all_tables) ? 
        [(object) ['Tables' => 'No tables larger than 10MB found!']] : 
    ...
    return (object) [
        'sections' => [
            ...
            (object) [
                'name' => 'Top 10 Autoloaded Options by Size',
            ...
            (object) [
                'name' => 'Main WordPress Table Sizes',
            ...
            (object) [
                'name' => 'Show Any Tables Larger Than 10MB',
