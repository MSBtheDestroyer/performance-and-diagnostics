...
function wpqr_site_health_tab_content($tab) {
    ...
    // Cache Details
    echo '<h3 class="health-check-accordion-heading"><button aria-expanded="false" class="health-check-accordion-trigger" aria-controls="health-check-accordion-block-cache" type="button"><span class="title">Cache Details</span><span class="icon"></span></button></h3>';
