...
function get_http_requests_info()
{
    ...
    // Fetch and set the server's timezone dynamically
    ...
    return (object) [
        'sections' => [
            (object) [
                'data' => [
                    (object) [
                        'Log Date' => date("Y-m-d") . ' (Today)',
                        'Number of HTTP Requests' => $today_requests,
                    ],
                    (object) [
                        'Date' => date("Y-m-d", strtotime("-1 day")) . ' (Yesterday)',
                        'Number of HTTP Requests' => $yesterday_requests,
                    ],
                ],
            ],
        ],
        ...
        'sections' => [
            (object) [
                'data' => array_map(function ($bot, $count) {
                    return (object) [
                        'Top 10 Bot hits (compatible)' => $bot,
                        'Count' => $count,
                    ];
